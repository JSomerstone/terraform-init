...
def get_parsed_arguments(arguments: list):
    ...
    parser.add_argument(
        "target",
        help="Where to create the project to, defaults to current working directory (.)",
        type=str,
        default=".",
    )
    parser.add_argument(
        "--name",
        "-n",
        help="Name of the project, defaults to name of the <target> directory",
        type=str,
        default="",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--awsprofile",
        "-a",
        help="The profile in your AWS configuration to use",
        type=str,
        default="default",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--force",
        "-f",
        help="Force overwrite of any existing files",
        action="store_true",
    )
